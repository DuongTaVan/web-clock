...
Route::group(['prefix' => 'admin', 'middleware' => 'checkLogin'], function () {
    ...
    Route::group(['prefix' => 'admin', 'middleware' => 'can:admin-list'], function () {
        //list user
        Route::get('', 'RolePermission\AdminController@getIndex')->name('user.list');
        //create user
        Route::get('create', 'RolePermission\AdminController@create')->name('user.add')->middleware('can:role-add');
        Route::post('create', 'RolePermission\AdminController@store')->name('user.postadd');
        Route::get('edit/{id}', 'RolePermission\AdminController@edit')->name('user.edit')->middleware('can:role-edit');
        Route::post('postedit/{id}', 'RolePermission\AdminController@postedit')->name('user.postedit');
        Route::get('delete/{id}', 'RolePermission\AdminController@delete')->name('user.delete')->middleware('can:role-delete');
    });
    //Role
    Route::group(['prefix' => 'roles', 'middleware' => 'can:role-list'], function () {
        //list user
        Route::get('', 'RolePermission\RoleController@getIndex')->name('role.list');
        //create user
        Route::get('create', 'RolePermission\RoleController@create')->name('role.add')->middleware('can:role-add');
        Route::post('create', 'RolePermission\RoleController@store')->name('role.postadd');
        Route::get('edit/{id}', 'RolePermission\RoleController@edit')->name('role.edit')->middleware('can:role-edit');
        Route::post('postedit/{id}', 'RolePermission\RoleController@postedit')->name('role.postedit');
        Route::get('delete/{id}', 'RolePermission\RoleController@delete')->name('role.delete')->middleware('can:role-delete');
    });
    //Permission
    ...
    Route::group(['prefix' => 'statistical', 'middleware' => 'can:statistical'], function () {
        Route::get('', 'Admin\AdminStatisticalController@index')->name('admin.statistical.index');
    });
    Route::group(['prefix' => 'warehouse', 'middleware' => 'can:warehouse'], function () {
        Route::get('', 'Admin\AdminWareHouseController@index')->name('admin.warehouse.index');
    });

    Route::group(['prefix' => 'menu', 'middleware' => 'can:menu'], function () {
    ...
    Route::group(['prefix' => 'keyword', 'middleware' => 'can:key'], function () {
    ...
    Route::group(['prefix' => 'attribute', 'middleware' => 'can:attribute'], function () {
    ...
    Route::group(['prefix' => 'trademark', 'middleware' => 'can:trademark'], function () {
    ...
    Route::group(['prefix' => 'event', 'middleware' => 'can:event'], function () {
    ...
    Route::group(['prefix' => 'slide', 'middleware' => 'can:slide'], function () {
...
//Route::get('/pusher', 'Frontend\ShoppingCartController@notificationOrder')->name('notification_order');

Route::get('/test', 'Realtime\ChatsController@index');
Route::get('messages', 'Realtime\ChatsController@fetchMessages');
Route::post('messages', 'Realtime\ChatsController@sendMessage');
