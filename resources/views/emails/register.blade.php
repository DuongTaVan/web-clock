<div style="width: 100%;max-width: 600px;margin:0 auto">
    ...
    <div style="background: #f4f5f5;box-sizing: border-box;padding: 15px;border-top:1px solid #dedede;border-bottom: 1px solid #dedede">
        <p>Xin Chào {{ $name }}</p>
        <p>Chúng tôi xin chân thành cảm ơn Bạn đã tin tưởng đăng ký và sử dụng dịch vụ của Duong G-A</p>
    ...
    <div style="background: #f4f5f5;box-sizing: border-box;padding: 15px">
        <p style="margin:2px 0;color: #333">Email : duongga2712@gmail.com</p>
        <p style="margin:2px 0;color: #333">Phone : 0123456789</p>
        <p style="margin:2px 0;color: #333">Face : <a href="">Dương Tiền Hải</a></p>
    </div>
</div>