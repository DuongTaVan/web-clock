        ...
        <div class="box-header width-border">
	        ...
	        <div class="box-body">
	        	<div class="col-md-8">
			            ...
			            <!-- /.box-header -->
			            <!-- form start -->
			            <form role="form" action="admin/trademark/createe" method="POST" enctype="multipart/form-data">
			            	@csrf
			              
			                <div class="form-group">
			                  <label >Name <span class="text-danger">(*)</span></label>
			                  <input type="text" name="trm_name" class="form-control"  placeholder="Name ...">
			                ...
			                <div class="form-group">
			                    ...
			                    <img height="57px" width="189px" src="" alt="" id="demo_image">
			              	</div>
