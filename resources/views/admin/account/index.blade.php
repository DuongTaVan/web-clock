...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="source/admin/adminlte/plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="source/admin/adminlte/index2.html"><b>Admin</b>LTE</a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Đăng nhập vào hệ thống Admin</p>
            @if(session('thongbao'))
            ...
            @endif
            <form action="account/postLogin" method="post">
                @csrf
    ...
    <!-- iCheck -->
    <script src="source/admin/adminlte/plugins/iCheck/icheck.min.js"></script>
    <script>
        $(function() {
            $('input').iCheck({
